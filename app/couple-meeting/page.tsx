    ...
    <div className="flex flex-col gap-6">
      ...
      <div className={cardClass}>
        ...
        <ul className={listClass}>
          ...
          <li>הכנת סקיצה ראשונית ב-iPlan לפי התחייבות נוכחית (עד יום אחרי הפגישה).</li>
          <li>עדכון התחייבות סופית בפרטי האירוע (כשבוע לפני האירוע).</li>
          <li>פתיחת הושבה (כשבוע לפני האירוע).</li>
          <li>הכנת סקיצה סופית (כשבוע לפני האירוע).</li>
          <li>העלאת סקיצה סופית לאתר - לאחר סיום הושבה (יום לפני האירוע).</li>
