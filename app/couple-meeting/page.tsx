    ...
    <div className="flex flex-col gap-6">
      ...
      <div className={cardClass}>
        ...
        <ul className={listClass}>
          ...
          <li>שליחת הנקודות העיקריות מהפגישה, וכן נקודות להמשך, לקבוצה (עד יום אחרי הפגישה).</li>
          <li>העלאת טופס אירוע (עד יום אחרי הפגישה).</li>
          ...
          <li>העלאת סקיצה סופית לאתר - לאחר התחייבות סופית (כשבוע לפני האירוע).</li>
