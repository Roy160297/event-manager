...
export const CLOSING_CHECKLIST: ClosingChecklistCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "lock-cafe-door", text: "נעילת דלת המטבחון/קפיטריה (מפתח: צהוב עגול)." },
      { key: "lock-main-gate", text: "נעילת שער הכניסה לאולם (מפתח: שחור עגול)." },
      ...
      { key: "lock-waiters-room-inner-door", text: "נעילת הדלת הפנימית בחדר המלצרים (מפתח: תכלת עגול)." },
      { key: "lock-emergency-exit", text: "נעילת דלת היציאה לפחים (מפתח: כחול RB)." },
      { key: "lock-inner-kitchen-door", text: "נעילת דלת המטבח הפנימי (מפתח: שחור מרובע)." },
      { key: "lock-outside-white-metal-door", text: "נעילת דלת יציאה לרחוב (ליד משרד השף) (מפתח: כחול RB)." },
      {
        key: "lock-hall-kitchen-disposal-door",
        text: "נעילת דלת היציאה לרחוב ממטבח הפינויים באולם (מפתח: שחור עגול 64P).",
      },
