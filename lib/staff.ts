...
// manager, matching staff whose assigned role is named "איש מכירות" (no
// slash - existing role names in this system are all written that way,
// e.g. "מנהל פלור" not "מנהל/ת פלור").
